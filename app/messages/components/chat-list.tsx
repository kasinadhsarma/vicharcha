                ...
                setFilteredChats(
                  chats.filter(
                    (chat) =>
                      ...
                      chat.participantDetails.some((p: { name: string }) => p.name.toLowerCase().includes(searchTerm)),
                  ),
                )
              }}
            />
                ...
                <div className="relative shrink-0">
                  <Avatar
                    className={cn(
                      ...
                      chat.participantDetails.some((p: { isPremium: boolean }) => p.isPremium) && "ring-2 ring-amber-500",
                    )}
                  >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-start mb-0.5 md:mb-1">
                    <div className="flex items-center gap-1">
                      ...
                      {chat.participantDetails.some((p: { isPremium: boolean }) => p.isPremium) && (
